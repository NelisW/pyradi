...
def photosensor(strh5):
    ...
    *fixed-pattern (time-invariant)* or *temporal (time-variant)*
    ...
    strh5['rystare/signal/electrons'][...] = strh5['rystare/signal/light'].value + \
              strh5['rystare/signal/dark'].value + strh5['rystare/noise/sf/source_follower_noise']
...
def sense_node_reset_noise(strh5):
    ...
    strh5['rystare/noise/sn/ResetKTC-Sigma'][...] = np.sqrt((strh5['rystare/constants/Boltzman-Constant-JK'].value) * (strh5['rystare/OperatingTemperature'].value) / (strh5['rystare/C_SN)'].value))
...
def create_data_arrays(strh5):
   ...
   """
    ...
    strh5['rystare/constants/quantumEfficiency'] = np.zeros(sensor_size)
...
def convert_to_electrons(strh5):
    ...
    strh5['rystare/constants/quantumEfficiency'][...] = strh5['rystare/ExternalQuantumEff'].value * strh5['rystare/constants/quantumYield'].value

    # number of electrons [e] generated in detector
    strh5['rystare/signal/light'][...] = strh5['rystare/signal/photons'].value * strh5['rystare/constants/quantumEfficiency'].value 
...
def responsivity_FPN_light(strh5):
    ...
    strh5['rystare/signal/light'][...] = strh5['rystare/signal/light'].value * strh5['rystare/detector/response/NU/value'].value
...
def responsivity_FPN_dark(strh5):
    ...
    *Simulation of dark current fixed pattern noise*
    ...
    strh5['rystare/signal/dark'][...] = strh5['rystare/signal/dark'].value * strh5['rystare/darkresponse/NU/value'].value
...
def run_example(doTest='Advanced', outfilename='Output', pathtoimage=None, 
    ...
    strh5['rystare/constants/quantumYield'] = 1. # number of electrons absorbed per one photon into material bulk
    ...
    with open('{}{}.txt'.format(prefix,outfilename), 'wt') as fo: 
        ...
        fo.write('{:26}, {:.5e}, {:.5e}\n'.format('signalLight',np.mean(strh5['rystare/signal/light'].value), np.var(strh5['rystare/signal/light'].value)))
        fo.write('{:26}, {:.5e}, {:.5e}\n'.format('signalDark',np.mean(strh5['rystare/signal/dark'].value), np.var(strh5['rystare/signal/dark'].value)))
        ...
        fo.write('{:26}, {:.5e}, {:.5e}\n'.format('SignalPhotons',np.mean(strh5['rystare/signal/photons'].value), np.var(strh5['rystare/signal/photons'].value)))
    ...
    if doPlots:
        lstimgs = ['rystare/signal/photonRateIrradiance','rystare/signal/photons','rystare/signal/electrons','rystare/signal/voltage',
                   'rystare/signal/DN','rystare/signal/light','rystare/signal/dark', 'rystare/detector/response/NU/value',
                   'rystare/darkresponse/NU/value','rystare/constants/quantumEfficiency']
    ...
    if doHisto:
        lstimgs = ['rystare/signal/photonRateIrradiance','rystare/signal/photons','rystare/signal/electrons','rystare/signal/voltage',
                   'rystare/signal/DN','rystare/signal/light','rystare/signal/dark',
                   'rystare/detector/response/NU/value','rystare/darkresponse/NU/value','rystare/constants/quantumEfficiency']
    ...
    if doImages:
        lstimgs = ['rystare/signal/photonRateIrradiance','rystare/signal/photonRate', 'rystare/signal/photons','rystare/signal/electrons','rystare/signal/voltage',
                    'rystare/signal/DN','rystare/signal/light','rystare/signal/dark', 'rystare/noise/sn_reset/resetnoise','rystare/noise/sf/source_follower_noise',
                    'rystare/detector/response/NU/value','rystare/darkresponse/NU/value','rystare/constants/quantumEfficiency']
