...
def photosensor(strh5):
    ...
    *fixed-pattern (time-invariant)* or *temporal (time-variant)*
    ...
    # calculate the source follower noise in electrons.  
    ...
    strh5['rystare/signal/electrons'][...] = strh5['rystare/signal/lightelectrons'].value + \
              strh5['rystare/signal/darkcurrentelectrons'].value + strh5['rystare/sourcefollower/source_follower_noise']
...
def source_follower_noise(strh5):
    ...
    *Random Telegraph Signal (RTS) noise*
    ...
    denomin = strh5['rystare/sensenode/gain'].value * strh5['rystare/sourcefollowergain'].value * (1 - np.exp(- (strh5['rystare/sourcefollower/CDS-sampletosamplingtime'].value) / tau_D)).reshape(-1,1)
